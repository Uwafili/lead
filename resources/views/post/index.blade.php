...
<div id="text-slideshow" class="w-full flex justify-center mb-8">
    <div
        id="slide-text"
        class="text-2xl md:text-2xl font-italic text-black-800 shadow-lg min-h-[70px] flex items-center justify-center px-6 py-4 rounded-xl transition-opacity duration-700 opacity-100"
...
<script>
    const slides = [
        ...
        "Contact center bring request, we bring table spoon let’s eat!",
        ...
        "We cook am so good, even Finance ask if we dey invoice!",
        ...
        "Hospital price dey run? We don hold am like thief for Oshodi!",
        ...
        "We slice Hospital bills like Provider Relations dey slice onboarding forms!",
        ...
        "Chef Team reporting live from PMU HQ.",
